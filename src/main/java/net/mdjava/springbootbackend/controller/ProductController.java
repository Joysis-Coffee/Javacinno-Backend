...
public class ProductController {
    ...
    public ResponseEntity<Product> update(@PathVariable long id, @RequestBody Product productDetails) {
        ...
        updateProduct.setSmall_price(productDetails.getSmall_price());
        updateProduct.setMedium_price(productDetails.getMedium_price());
        updateProduct.setLarge_price(productDetails.getLarge_price());
